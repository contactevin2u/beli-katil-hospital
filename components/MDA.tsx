      ...
      <div className="container-x grid lg:grid-cols-2 gap-12 items-center">
        <div>
          <span className="pill !bg-white/10 !text-white">
            <Landmark size={14} /> Daftar rasmi
          </span>
          <h2 className="text-3xl sm:text-4xl font-extrabold mt-3 leading-tight">
            Daftar dengan MDA Malaysia — semua unit asli, bukan replica
          </h2>
          <p className="mt-4 text-brand-100 max-w-xl">
            Setiap katil yang kami sewa atau jual didaftar di bawah{' '}
            ...
            second-hand pasaran gelap — boleh sahkan terus di portal MDA.
          </p>
