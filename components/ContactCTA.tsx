      ...
      <div className="container-x text-center max-w-3xl mx-auto">
        ...
        <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center">
          <a
            ...
            target="_blank"
            rel="noopener"
            className="inline-flex items-center justify-center gap-2 rounded-full bg-white text-accent-600 hover:bg-green-50 font-bold px-8 py-4 shadow-soft text-base"
          >
            <WhatsApp size={20} />
            Chat di WhatsApp
          </a>
        ...
        <div className="mt-8 grid sm:grid-cols-3 gap-3 text-sm text-green-50">
